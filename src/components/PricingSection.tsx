...
const PricingSection = () => {
  ...
  const [selectedOption, setSelectedOption] = useState<PricingOption>("normal");

  const openModal = useCallback((option: PricingOption) => {
  ...
  return (
    <section id="pricing" className="section-dark-alt py-20 sm:py-28">
      <div className="max-w-5xl mx-auto px-4 sm:px-6">
        <AnimatedSection>
          <h2 className="font-display text-3xl sm:text-4xl font-bold text-center mb-4">
            A decisão que vai{" "}
            <span className="text-gradient-gold">mudar o rumo</span> da sua vida.
          </h2>

          <p className="text-muted-foreground text-center mb-8 max-w-2xl mx-auto">
            Tudo o que você precisa fazer AGORA é dar o primeiro passo para se tornar
            um Maestro da Oratória e começar a colher os frutos dessa transformação
            pessoal e profissional.
          </p>

          <h3 className="font-display text-2xl font-bold text-center mb-3">
            Escolha seu melhor acesso ao{" "}
          ...
          <AnimatedSection delay={0.1}>
            <div className="border border-border rounded-lg bg-card flex flex-col h-full">
              ...
              <div className="p-8 pt-0">
                {/* ✅ Abre o modal para o plano normal */}
                <button
                  type="button"
            ...
            <div className="border border-primary/40 rounded-lg bg-card flex flex-col h-full relative overflow-hidden shadow-gold">
              ...
              <div className="p-8 flex-1">
                ...
                <div className="mb-6">
                  ...
                  <p className="text-muted-foreground text-sm">
                    Ou à vista por:{" "}
                    <span className="text-foreground font-semibold">R$ 997</span>
                  </p>
                </div>
              </div>

              <div className="p-8 pt-0">
                {/* ✅ Abre o modal para o plano vip */}
                <button
                  type="button"
        ...
        <AnimatedSection delay={0.3}>
          <div className="mt-16 max-w-3xl mx-auto text-center space-y-4">
            ...
            <p className="text-muted-foreground leading-relaxed">
              Você pode ter o melhor conteúdo, a melhor formação, o maior propósito,
              mas se não consegue transmitir isso com clareza e autoridade em cada
              palavra que sai da sua boca, você será ignorado(a).
            </p>

            <p className="text-muted-foreground leading-relaxed">
              E enquanto isso, pessoas com menos conhecimento e menos profundidade
              ocupam os espaços que poderiam ser seus.
            </p>
            ...
            <p className="text-muted-foreground leading-relaxed">
              E se você não aprender a expressá-la com clareza e presença, ela morrerá
              com você.
            </p>

            <p className="text-primary font-semibold text-lg mt-6">
              Nos próximos dias 27 e 28 de Fevereiro de 2026, você pode mudar isso de
              uma vez por todas.
            </p>
          </div>
        </AnimatedSection>
        ...
        <AnimatedSection delay={0.4}>
          <div className="mt-10 text-center">
            {/* Esse CTA pode ir pro pricing e abrir o modal padrão (normal) */}
            <button
              type="button"
              onClick={() => openModal("normal")}
      ...
      {/* ✅ Modal montado uma vez só, controlado por state */}
      <LeadCaptureModal
        isOpen={isModalOpen}
        onClose={closeModal}
